...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-gray-950 text-white relative">
      ...
      {/* My notification when the email successfully sends */}
      {showSuccessAnim && (
